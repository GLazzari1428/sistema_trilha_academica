...
perfil(desenvolvimento_web, usabilidade, 4).

perfil(seguranca_da_informacao, logica, 4).
...
perfil(ciencia_de_dados, visualizacao_de_dados, 3).
...
perfil(devops, automatizacao, 5).
perfil(devops, conhecimento_cloud, 4).
perfil(devops, programacao, 3).
perfil(devops, gerenciamento_de_configuracoes, 4).

perfil(jogos_digitais, criatividade, 5).
perfil(jogos_digitais, design_visual, 4).
perfil(jogos_digitais, programacao, 3).
